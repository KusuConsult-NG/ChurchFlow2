...
export default function SignUpPage() {
  ...
  const organizationTypes = [
    { value: 'GCC', label: 'General Church Council (GCC)' },
    { value: 'DCC', label: 'District Church Council (DCC)' },
    { value: 'LCC', label: 'Local Church Council (LCC)' },
    { value: 'LC', label: 'Local Church (LC)' },
  ]
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <Card className="churchflow-card">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Join ChurchFlow to manage your organization
            </CardDescription>
          </CardHeader>
