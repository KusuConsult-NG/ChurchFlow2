...
function SignInForm() {
  ...
  useEffect(() => {
    ...
    if (error === 'google') {
      setErrors({ general: 'Google authentication failed. Please try again or contact support if the issue persists.' })
    }
  }, [searchParams])
        ...
        <Card className="churchflow-card">
          ...
          <CardContent className="space-y-6">
            ...
            <Button
              ...
              disabled={loading}
              className="w-full churchflow-secondary flex items-center justify-center space-x-2"
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Link href="/auth/reset-password" className="text-sm text-primary-500 hover:text-primary-600">
